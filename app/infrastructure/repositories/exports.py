        ...
        return [
            ...
            self._tank_child_table(
                ...
                select(
                    ...
                    TankMaintenanceConfigModel.config_key,
                    TankMaintenanceConfigModel.config_type,
                    TankMaintenanceConfigModel.task_label,
                    TankMaintenanceConfigModel.enabled,
                    TankMaintenanceConfigModel.interval_days,
                    TankMaintenanceConfigModel.schedule_mode,
                    TankMaintenanceConfigModel.preferred_weekday,
                    TankMaintenanceConfigModel.start_date,
                    TankMaintenanceConfigModel.reminders_enabled,
                    TankMaintenanceConfigModel.notes,
                    TankMaintenanceConfigModel.provenance,
                    TankMaintenanceConfigModel.profile_key,
                ),
                TankMaintenanceConfigModel.tank_id,
            ),
            self._tank_child_table(
            ...
            self._table(
                ...
                select(
                    ...
                    ReminderModel.maintenance_config_id,
                    ReminderModel.reminder_type,
                    ReminderModel.title,
                    ReminderModel.due_at,
                    ReminderModel.completed_at,
                    ReminderModel.superseded_at,
                    ReminderModel.superseded_reason,
